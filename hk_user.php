                    ...
                    <div class="smart-widget-body">
                        <form class="form-horizontal" name="txform" id="txform">
							 ...
							 <input type="hidden" name="mobile" id="mobile" value="';echo $user["mobile"];echo '">
                                ...
                                <div class="col-lg-8">
                                    <select name="bankid" id="bankid" value="1" class="form-control">
                                        	<option value="yh">';echo $cssz["khh"]." ";;echo '';echo $cssz["yhzh"]." ";;echo '';echo $cssz["hz"];echo '</option>
										<option value="zfb">支付宝 ';echo $cssz["zfb"]." ";;echo '';echo '';echo $cssz["hz"];echo '</option>
										<option value="btb">比特币 ';echo $cssz["btb"]." ";echo '</option>
										<option value="wx">微信 (请扫描以上的二维码进行支付)</option>';
										if($cssz["hkzh1"]){ echo '<option value="wx">'.$cssz["hkzh1"].'</option>';}
										if($cssz["hkzh2"]){ echo '<option value="wx">'.$cssz["hkzh1"].'</option>';}
										if($cssz["hkzh3"]){ echo '<option value="wx">'.$cssz["hkzh1"].'</option>';}
										if($cssz["hkzh4"]){ echo '<option value="wx">'.$cssz["hkzh1"].'</option>';}
										if($cssz["hkzh5"]){ echo '<option value="wx">'.$cssz["hkzh1"].'</option>';}
                                    echo '</select>
                                </div><!-- /.col -->
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" class="form-control" required name="hkname" disabled id="hkname" value="';echo $_SESSION["glo_realname"];echo '"
                                           placeholder="汇款人">
                                </div><!-- /.col -->
                            </div>
                            <div class="form-group">
